...
<svg width="300" height="160" viewBox="0 0 300 160" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle r="45" cx="70" cy="80" fill="transparent" stroke="#ffa116" stroke-width="10" 
          stroke-dasharray="2.388818297331639 97.61118170266836" stroke-dashoffset="25" stroke-linecap="round"/>
  
  <text x="70" y="82" font-family="Arial" font-size="16" font-weight="bold" fill="#ffffff" text-anchor="middle">94</text>
  <text x="70" y="98" font-family="Arial" font-size="10" fill="#888888" text-anchor="middle">Solved</text>
  
  <text x="150" y="55" font-family="Arial" font-size="13" font-weight="bold" fill="#22c55e">🟢 Easy: 62</text>
  <text x="150" y="85" font-family="Arial" font-size="13" font-weight="bold" fill="#eab308">🟡 Medium: 32</text>
  <text x="150" y="115" font-family="Arial" font-size="13" font-weight="bold" fill="#ef4444">🔴 Hard: 0</text>
</svg>
...
|  |
| ------- |
| [0110-balanced-binary-tree](https://github.com/nguyentridung3886641/LeetCode-Problems-Solved/tree/master/0110-balanced-binary-tree) |
## Depth-First Search
|  |
| ------- |
| [0110-balanced-binary-tree](https://github.com/nguyentridung3886641/LeetCode-Problems-Solved/tree/master/0110-balanced-binary-tree) |
