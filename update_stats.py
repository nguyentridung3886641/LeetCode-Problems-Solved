...
# 2. Truy vấn GraphQL chính chủ đến LeetCode (Không lo bị chặn)
...
try:
    ...
    # Phân tích dữ liệu trả về từ API LeetCode
    ...
    # 3. Thuật toán tính toán tọa độ góc để vẽ vòng tròn Tiến độ (SVG Stroke-dasharray)
    # Chu vi đường tròn bán kính R=50 là 2 * pi * 50 = 314.16
    ...
    dash_remaining = CIRCUMFERENCE - (dash_easy + dash_medium + dash_hard)

    # 4. Tạo chuỗi SVG giả lập giao diện đồ thị LeetCode (Dark Theme)
    svg_content = f"""<svg width="350" height="170" viewBox="0 0 350 170" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="90" cy="85" r="50" stroke="#22c55e" stroke-width="10" 
                stroke-dasharray="{dash_easy} {CIRCUMFERENCE - dash_easy}" stroke-linecap="round" transform="rotate(-90 90 85)"/>
    ...
    print(f"Lỗi khi cào dữ liệu LeetCode: {e}")
